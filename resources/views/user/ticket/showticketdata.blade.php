        ...
        @if ($loop->first)
            ...
            <div class="card-body">
                <div class="d-sm-flex">
                                            ...
                                            <div class="file-image-1  removespruko{{ $commentss->id }}"
                                                ...
                                                <div class="product-image  ">
                                                    <a href="{{ $commentss->getFullUrl() }}" class="imageopen">
                                                        <img src="{{ $commentss->getFullUrl() }}" class="br-5"
                                                            alt="{{ $commentss->file_name }}">
                                                    </a>
                                                    <ul class="icons">
                                                        <li><a href="javascript:(0);" class="bg-danger imgdel"
                                                                data-id="{{ $commentss->id }}"><i class="fe fe-trash"
                                                                    data-id="{{ $commentss->id }}"></i>@csrf</a></li>
                                                    </ul>
                                                </div>
                    ...
                    @if (Auth::guard('customer')->id() == $comment->cust_id)
                        <div class="ms-auto">
                            <span class="action-btns supportnote-icon" onclick="showEditForm('{{ $comment->id }}')"><i
