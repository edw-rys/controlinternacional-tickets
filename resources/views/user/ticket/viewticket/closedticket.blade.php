            ...
            <div class="header-text mb-0">
                <div class="container ">
                    <div class="row text-white">
                        <div class="col">
                            <h1 class="mb-0">{{ trans('langconvert.adminmenu.closetickets') }}</h1>
                        </div>
                        <div class="col col-auto">
                            <ol class="breadcrumb text-center">
                                ...
                                <li class="breadcrumb-item active">
                                    <a href="#"
                                        class="text-white">{{ trans('langconvert.adminmenu.closetickets') }}</a>
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="card mb-0">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <button id="massdelete"
                                        class="btn btn-outline-light btn-sm ms-7 mb-4 data-table-btn  mx-md-center"><i
                                            class="fe fe-trash me-1"></i>
                                        {{ trans('langconvert.admindashboard.delete') }}</button>
                                    <table
