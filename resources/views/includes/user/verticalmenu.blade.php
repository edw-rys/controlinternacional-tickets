	...
	<div class="card">
		<div class="card-body text-center item-user">
			<div class="profile-pic">
				...
				<br>
				<small class="text-muted ">{{Auth::guard('customer')->user()->station_name}}</small>
				{{-- <br> --}}
				{{-- <small class="text-muted ">{{Auth::guard('customer')->user()->username}}</small> --}}
			</div>
			<div class="btn-list">
				@if (Auth::user()->image != null)

				<a href="javascript:void(0)" class="btn btn-light mt-3"
					data-id="{{Auth::guard('customer')->id()}}" onclick="deletePost(event.target)">@lang('langconvert.usermenu.deletephoto')</a>
				@endif
		...
		<div class="support-sidebar">
			<ul class="side-menu custom-ul">
				...
				<li>
					<a class="side-menu__item" href="{{route('tickets-list', 'active')}}">
				...
				<li>
					<a class="side-menu__item" href="{{route('tickets-list', 'close')}}">
				...
				<li>
					<a class="side-menu__item" href="{{route('tickets-list', 'onhold')}}">
