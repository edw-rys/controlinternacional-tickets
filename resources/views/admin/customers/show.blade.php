                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-12">
                            <div class="form-group">
                                <label class="form-label">{{ trans('langconvert.adminmenu.customer') }}</label>
						...
						<div class="col-sm-12 col-md-6">
                            <div class="form-group">
                                <label class="form-label">{{ trans('langconvert.admindashboard.password') }}</label>
                                <input type="password" class="@error('password') is-invalid @enderror form-control" name="password" value="" placeholder="***********">
								@error('password')
									<span class="invalid-feedback" role="alert">
										<strong>{{ $message }}</strong>
									</span>
                        ...
                        {{-- <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control " Value="{{ $user->country }}" name="timezone"
                                    readonly>
                            </div>
                        </div> --}}
                        {{-- <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control " Value="{{ $user->timezone }}" name="timezone"
                                    readonly>
                            </div>
                        </div> --}}
                        <div class="col-md-12">
                                ...
                                <select class="form-control  select2" data-placeholder="Select Status" name="status">
                                    ...
                                    @if ($user->status === '1')
                                        <option value="{{ $user->status }}"
                                            @if ($user->status === '1') selected @endif>Activo</option>
                                        <option value="0">Inactivo</option>
                                    @else
                                        <option value="{{ $user->status }}"
                                            @if ($user->status === '0') selected @endif>Inactivo</option>
