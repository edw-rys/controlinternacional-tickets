@extends('layouts.adminmaster')
		...
		@endsection
							...
							<div class="page-header d-xl-flex d-block">
								<div class="page-leftheader">
									<h4 class="page-title"><span class="font-weight-normal text-muted ms-2">{{trans('langconvert.adminmenu.myassigntickets')}}</span></h4>
								</div>
							</div>
							<!--End Page header-->
							...
							<div class="col-xl-12 col-lg-12 col-md-12">
								<div class="card ">
									<div class="card-header border-0">
										<h4 class="card-title">{{trans('langconvert.adminmenu.myassigntickets')}}</h4>
									</div>
									<div class="card-body" >
											...
											<table class="table table-vcenter text-nowrap table-bordered table-striped ticketdeleterow w-100" id="myassignedticket">
												<thead >
													<tr >
														...
														<th >{{trans('langconvert.admindashboard.assignby')}}</th>
		...
		<script type="text/javascript">
			...
			(function($)  {
				...
				// Datatable
				var table = $('#myassignedticket').DataTable({language : languajeDT,
					processing:true,
					serverSide:true,
					ajax: {
					...
					columns: [
						...
						{ data: 'myassignuser_id', name: 'myassignuser_id' },
